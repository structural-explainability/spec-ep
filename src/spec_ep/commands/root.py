# src/spec_ep/commands/root.py
"""Root command dispatcher."""

import argparse

from spec_ep.commands.manifest import sync_main
from spec_ep.commands.reference import ref_export_main, ref_validate_main
from spec_ep.commands.validate import validate_main


def main(argv: list[str] | None = None) -> int:
    """Dispatch spec_ep commands."""
    parser = argparse.ArgumentParser(description="spec-ep command line interface.")

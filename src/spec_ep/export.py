# src/spec_ep/export.py
"""Export generated EP machine-readable specification artifacts."""

from dataclasses import asdict, dataclass
import json
from pathlib import Path

from spec_ep.extractor_utils import (
    Requirement,
...
from spec_ep.load import load_text
from spec_ep.paths import data_spec_path, repo_root
...
def extract_scope_exclusions(markdown: str) -> list[str]:
    """Extract bullets from the EP.SCOPE.EXCLUSIONS section."""
    ...
    for line in lines:
        ...
        if stripped == "## EP.SCOPE.EXCLUSIONS":
            in_section = True
            continue
    ...
    if not exclusions:
        raise ValueError("No scope exclusions found in EP.SCOPE.EXCLUSIONS.")

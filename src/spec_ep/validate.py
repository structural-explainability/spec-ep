# src/spec_ep/validate.py
"""Validate EP specification consistency."""

from pathlib import Path

from spec_ep.export import SPEC_ID, build_conformance_export, build_requirements_export
...
from spec_ep.paths import repo_root

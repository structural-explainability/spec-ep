...
def test_scope_exclusions_export_is_non_empty() -> None:
    ...
    assert any("domain vocabularies" in item for item in export.excluded)
    assert "identity regimes" in export.excluded
